...
<head>
    <meta charset="utf-8" />
    <title> Ver mas tarde - YouTube</title>
...
<body class="yt-background-color">
    ...
    <div class="container-fluid no-padding mt-5">
                    ...
                    <div class="border-bottom pt-2 pb-2">
                        ...
                        <div class="entrada">
                            <a href="ver_mas_tarde.php" class="ml-2 d-block">
                                <i class="btn btn-ligth fas fa-clock fa-lg pt-3 pb-3 ml-2 mr-2 selected"></i>Ver más Tarde
                            </a>
                        </div>
                        <div class="entrada">
                ...
                <div class="body-grid">
                    <div class="row">
                        <div class="col-4">
                            <div class="row">
                                <div class="col-12">
                                    <img class="img-fluid" id="img-primer-video">
                                </div>
                                <div class="col-12 mt-4">
                                    <label class="content-name font-weight-bold" style="font-size: 22px;">Ver mas Tarde</label>
                                </div>
                                <div class="col-12 text-justify">
                                    Esta es una lista de reproduccion de todos aquellos videos que quieres ver despues.   
                            
                                </div>
                            </div>
                        </div>
                        <div class="col-8 float-right" style="background-color: white;" id="div-videos_mas">
        ...
        <script src="js/mas_tarde.js"></script>
