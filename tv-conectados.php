                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <div class="account-box">
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="account-header header-account-color">Reproduce videos en tu televisor</h5>
                                        <hr>
                                    </div>
                                    <div class="col-6">
                                        <div class="row ml-4 mt-2 yt-color">
                                            <div class="col-12 mb-3">
                                                <span class="steps">1</span>Abre YouTube en tu dispositivo de TV.
                                            </div>
                                            <div class="col-12 mb-3">
                                                <span class="steps">2</span> Navega a la configuración y selecciona "Vincular TV y teléfono".
                                            </div>
                                            <div class="col-12 mb-3">
                                                <span class="steps">3</span>Ingresa el código de TV de color azul que aparece en tu TV en el
                                                siguiente recuadro.
                                            </div>
                                            <div class="col-12 mb-3">
                                                <span class="steps">4</span>Haz clic en el ícono &nbsp;
                                                <i class="fas fa-tv"></i> &nbsp;para seleccionar la pantalla en la que quieres reproducir el video.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <img src="img/tv-remote.png" class="img-fluid"></img>
                                    </div>
                                    <div class="col-12">
                                        <hr class="bar-config">
                                    </div>
                                    <div class="col-12">
                                        <h6 class="account-header header-account-color">Vincular con código de TV</h6>
                                    </div>
                                    <div class="col-12 mb-4">
                                        <form class="form-inline mt-4 ">
                                            <input type="text" name="txt-tv" class="form-control form-control-sm ml-4 mr-4" placeholder="Ingresar codigo de TV">
                                            <button disabled="disabled" class="btn btn-secondary btn-sm">Agregar este televisor</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
