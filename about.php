    ...
    <div class="container-fluid no-padding mt-5">
        <div class="row no-gutters">
            ...
            <aside class="sidebar col-xl-2 col-lg-2 col-md-2 nav flex-column  d-block navbar-fixed-left" id="barraNav">
                ...
                </div><div id="ocultar-al-login2" class="border-bottom pt-2 pb-2">
                    <div class="ml-2 mr-2 pt-2 pb-2">
                        <p>Accede ahora para ver tus canales y recomendaciones.</p>
                        <a href="inicio-google.html" title="" id="link-acceso">
                            INICIAR SESIÓN
                        ...
                        <div class="body-grid">
                            <div class="row">
                                <div class="col-lg-9 col-md-9 col-9">
                                    ...
                                    <div class="contenido">
                                        <p class="txt-13p">
                                            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Repellendus impedit voluptas quia possimus velit incidunt praesentium
                                            alias quas quam molestias tenetur, animi ipsum odit inventore sequi aut tempore
                                            facilis commodi?
                                        </p>
                                        <hr>
                                        <div class="content-name">
                                        ...
                                        <a href="#" class="color-link">Generado automáticamente por YouTube</a>
                                    </div>
                                </div>
