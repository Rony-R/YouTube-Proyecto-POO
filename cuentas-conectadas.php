        ...
        <div class="row no-gutters">
            ...
            <aside class="sidebar col-xl-2 col-lg-2 col-md-2 nav flex-column collapse d-none d-xl-none navbar-fixed-left" id="barraNav">
                <div class="border-bottom pt-2 pb-2">
                    ...
                    <div class="entrada">
                        <a href="tendencias.html" title="Tendencias">
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <div class="account-box">
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="account-header">Cuentas Conectadas</h5>
                                        <hr>
                                    </div>
                                    <div class="col-12 mb-2">
                                        <h6 class="account-header pt-2 header-account-color">Conectar cuentas</h6>
                                    </div>
                                    <div class="col-12">
                                        <div class="row ml-4 mt-2 mb-1">
                                            <div class="col-3 ml-4 offset-9">
                                                <div class="cta-box">
                                                    <div class="social-box">
                                                        <img src="img/assets/twitter-icon.png" class="img-fluid" alt="img-responsive"> &nbsp;Twitter
                                                        <button class="btn btn-primary btn-sm ml-5">Conectar</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <h6 class="account-header header-account-color pl-3">Comparte tu actividad pública con las cuentas asociadas.</h6>
                                        </div>
                                        <div class="col-12">
                                            <div class="row ml-4 mt-1">
                                                <table class="table xs-text">
                                                    <tr class="border-bottom">
                                                        <td>
                                                            Subir un video
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="chk-cuentas" disabled checked>
                                                        </td>

                                                    </tr>
                                                    <tr class="border-bottom">
                                                        <td>
                                                            Agregar un video a una lista de reproducción pública
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="chk-cuentas" disabled checked>
                                                        </td>
                                                    ...
                                                    <tr class="border-bottom">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="chk-cuentas">
                                                        </td>
                                        ...
                                        <div class="col-12 mt-2 text-left yt-color ml-2 xs-text mb-4">
                                            Estos cambios solo afectan el uso compartido de las actividades de aquí en adelante. Los elementos que ya se hayan compartido
                                            fuera de YouTube permanecerán en esos sitios externos.
                                            <br>
                                            <p class="mb-1">Visita la
                                                <a href="#">configuración del feed</a> para administrar qué actividades públicas se publican
                                                en tu feed de actividad.
                                            </p>
