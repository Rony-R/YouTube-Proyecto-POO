    ...
    <div class="container-fluid no-padding mt-5">
        <div class="row no-gutters">
            ...
            <aside class="sidebar col-xl-2 col-lg-2 col-md-2 nav flex-column d-block navbar-fixed-left" id="barraNav">
                ...
                <div class="border-bottom pt-2 pb-2">
                    <div class="entrada">
                        <a href="configuracion.html" title="Inicio">
                    ...
                    <div class="nombre-canal">
                        <div class="header">
                            <div class="row">
                                <div class="col-lg-2 foto-canal">
                                    <span>
                                        <img id="asset-categoria" src="<?php echo $_GET["foto_canal"]?>" class="img-size-asset ml-5 mt-4 mb-4">
                                    </span>
                                </div>
                                <div class="col-lg-4 pt-4 mt-2">
                                    <span class="nombre-suscriptores">
                                        <h4 id="nombre-categoria"><?php echo $_GET["nombre_canal"]?></h4>
                                        <p id="suscriptores-categoria"><?php echo $_GET["num_suscriptores"]?> Suscriptores</p>
                                    </span>
                                </div>
                        ...
                        <div class="footer">
                            <div class="btn-group item-center mt-2" role="group" aria-label="Basic example">
                                <button onclick="obtenerInfoCanal('<?php echo $_GET['nombre_canal']?>')" type="button" class="btn btn-light">INICIO</button>
