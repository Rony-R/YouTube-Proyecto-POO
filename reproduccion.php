                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <div class="account-box">
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="account-header header-account-color">Reproducción</h5>
                                        <hr>
                                    </div>
                                    <div class="col-12 mb-2">
                                        <h6 class="account-header pt-2">Anotaciones y notificaciones en el video</h6>
                                    </div>
                                    <div class="col-12 ml-4 mb-4">
                                        <label>
                                            <input type="checkbox" name="chk-reprod" checked class="mr-2"> Mostrar anotaciones y notificaciones en el video
                                        </label>
                                        <a href="#">
                                    ...
                                    <div class="col-12 mb-2">
                                            <h6 class="account-header pt-2">Subtitulos</h6>
                                        </div>
                                    <div class="col-12 ml-4">
                                        <label>
                                            <input type="checkbox" name="chk-subt-1" checked class="mr-2"> Mostrar siempre subtítulos
                                        </label>
                                        <br>
                                        <label>
                                            <input type="checkbox" name="chk-subt-1" class="mr-2"> Mostrar subtítulos automáticos mediante reconocimiento de voz (cuando estén
                                            disponibles)
                                        </label>
                                        <br>
                                        <button class="btn btn-primary btn-sm mt-4 mb-4">Guardar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
