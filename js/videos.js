$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (respuesta) {
            ...
            $("#informacion0").append(respuesta.canal +"<br>"+ respuesta.visualizaciones +"<br>"+ respuesta.tiempo_subida);
            $("#miniatura1").attr("src",respuesta.miniatura);
            $("#titulo-video1").append(respuesta.titulo);
            $("#informacion1").append(respuesta.canal +"<br>"+ respuesta.visualizaciones +"<br>"+ respuesta.tiempo_subida);
            $("#miniatura2").attr("src",respuesta.miniatura);
            $("#titulo-video2").append(respuesta.titulo);
            $("#informacion2").append(respuesta.canal +"<br>"+ respuesta.visualizaciones +"<br>"+ respuesta.tiempo_subida);
            $("#miniatura3").attr("src",respuesta.miniatura);
            $("#titulo-video3").append(respuesta.titulo);
            $("#informacion3").append(respuesta.canal +"<br>"+ respuesta.visualizaciones +"<br>"+ respuesta.tiempo_subida);
        }
    });
