                ...
                <div class="header-canal">
                    ...
                    <div class="div-miniaturas">
                        <div class="body-grid">
                            ...
                            <main class="col-md-10 col-12 main ml-5" id="yt-body">
                                    <div class="content-name">
                                        Lo Mejor de YouTube
                                    </div>
                                    <div class="container">
